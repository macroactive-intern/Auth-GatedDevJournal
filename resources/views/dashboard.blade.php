        ...
        <div class="max-w-7xl mx-auto space-y-6 sm:px-6 lg:px-8">
            ...
            <section class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form method="GET" action="{{ route('dashboard') }}" class="mt-6 flex flex-col gap-3 sm:flex-row">
                        <div class="flex-1">
                            <x-input-label for="search" :value="__('Search public entries')" />
                            <x-text-input
                                id="search"
                                name="search"
                                type="search"
                        ...
                        <div class="flex items-end gap-3">
                            ...
                            @if ($search)
                                <a href="{{ route('dashboard') }}" class="mb-2 text-sm font-medium text-gray-600 hover:text-gray-900">
                                    {{ __('Clear') }}
                                </a>
                            @endif
                        </div>
                        ...
                        @empty
                            <div class="rounded-md border border-dashed border-gray-300 p-6 text-center">
                                <p class="text-sm text-gray-600">
                                    {{ $search ? __('No public entries match your search.') : __('No public entries yet.') }}
                                </p>
